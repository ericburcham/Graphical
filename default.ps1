...
task BuildDebug -description "Builds Graphical.sln in the debug configuration." {
    Invoke-Compile $SolutionFile "Debug" "Any CPU"
}

task BuildDebugWithPrerequisites -description "Builds Graphical.sln in the debug configuration.  Runs prerequisite steps first." -depends CleanAll, RestorePackages, BuildDebug

task BuildRelease -description "Builds Graphical.sln in the release configuration." {
    Invoke-Compile $SolutionFile "Release" "Any CPU"
}

task BuildReleaseWithPrerequisites -description "Builds Graphical.sln in the debug configuration.  Runs prerequisite steps first." -depends CleanAll, RestorePackages, BuildRelease
...
task Start:VisualStudio -description "Opens Graphical.sln in Visual Studio" {
    Invoke-Item .\Source\Graphical.sln
}
